...
CREATE TABLE "workout_schedule" (
    ...
    "schedule_date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "workout_steps_key" ON "workout"("steps");

-- CreateIndex
CREATE UNIQUE INDEX "sport_type_sport_type_key" ON "sport_type"("sport_type");

-- AddForeignKey
ALTER TABLE "workout" ADD CONSTRAINT "workout_sport_type_id_fkey" FOREIGN KEY ("sport_type_id") REFERENCES "sport_type"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
