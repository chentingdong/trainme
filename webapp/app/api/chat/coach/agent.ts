...
import { workoutPlannerNode, workoutPlannerTools } from '@/app/api/chat/coach/workoutPlanner';
...
const graph = new StateGraph(StateAnnotation)
  ...
  .addConditionalEdges(
        ...
        async (state: typeof StateAnnotation.State) => {
          ...
          const nextRepresentative = lastMessage.content;
          if (nextRepresentative === 'WORKOUT_PLANNER') {
            return 'workout_planner';
          } else if (nextRepresentative === 'ACTIVITY_ANALYZER') {
